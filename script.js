...
// List Editing Elements:
const editListModal = document.getElementById('edit-list-modal');
const editListForm = document.getElementById('edit-list-form')
const editColorPicker = document.getElementById('editing-color-picker');
const editListTitle = document.getElementById('editing-list-title-input');
const cancelListEdit = document.getElementById('cancel-list-edit');
...
const editTaskForm = document.getElementById('task-detail-form');
...
function setupEventListeners() {
    tasksContainer.addEventListener('click', handleTaskEdit);  // Open Edit Task Modal
    editTaskForm.addEventListener('submit', handleEditTaskFormSubmit);  // Submit Edit Task Form
    ...
    cancelListEdit.addEventListener('click', () => editListModal.classList.add('hidden'))  // Cancel List Edit
...
function disableTaskInputs() {
    ...
    editListBtn.style.setProperty('cursor', 'not-allowed');
    newTaskInput.value = '';
}
...
function enableTaskInputs() {
    ...
    editListBtn.style.setProperty('cursor', 'pointer');
}
