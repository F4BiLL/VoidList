...
export function renderSelectedList(listsJSON, currentListTitle, tasksContainer, taskFilter, sortSelect) {
            ...
            tasksContainer.insertAdjacentHTML('beforeend', `
                <div class="task-item priority-${task.priority} fade-in" data-id="${task.id}">
                    ...
                    <div class="task-content ${task.completed ? 'completed' : ''}">
                        ...
                        <div class="task-meta">
                            ${escapedDesc ? `<span class="task-description">${escapedDesc}</span>` : ''}
                            ${(escapedDesc && escapedDue) ? `<span class="separator">|</span>` : ''}
                            ${escapedDue ? `<span class="task-due">${escapedDue}</span>` : ''}
                        </div>
                    </div>
...
export function displayListsForExport(exportListSpace, downloadListBtn, shareListBtn, listsJSON) {
